...
int             call_the_OS(const char* cmd); 
...
bool            substitute_synonyms_cmdline(const char *s, string& sout, bool allow_math);
bool            substitute_synonyms(const char *s, string& sout, bool allow_math);
