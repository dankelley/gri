% $Id: refcard.tex,v 1.1 2000/05/11 15:07:23 dankelley Exp $
...
\centerline{(c) Dan E. Kelley 1999}
This PostScript document is available on the World Wide Web at {\it
ftp://ftp.phys.ocean.dal.ca/pub/receive/kelley/gri/refcard.ps}.
See also {\it cmdrefcard.ps}, which is a companion reference card, as
